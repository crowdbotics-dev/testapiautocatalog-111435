...
## Project Structure
    ...
    ├── testapiautocatalog_111435  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111435`
...
2. Clone this repo and `cd testapiautocatalog_111435`
